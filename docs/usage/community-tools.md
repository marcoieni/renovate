...
[`renovate-pretty-log-tui`](https://gitlab.com/tanna.dev/renovate-pretty-log/) is a Terminal User Interface to provide a richer, local-only view, for your Renovate debug logs.
